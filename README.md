...
cloc|github.com/AlDanial/cloc v 1.82  T=0.10 s (2828.8 files/s, 439375.3 lines/s)
--- | ---

Language|files|blank|comment|code
:-------|-------:|-------:|-------:|-------:
Python|106|2337|2872|7528
HTML|17|2240|35|6842
Markdown|46|664|0|5379
...
```
*   763d117 (HEAD -> master) Merge branch 'python-snippets'
|\  
...
* | | | | a6bcf86 (origin/master, origin/epidemic-modelling, epidemic-modelling) more directory restructuring/reorganization
