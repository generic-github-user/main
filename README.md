...
cloc|github.com/AlDanial/cloc v 1.82  T=0.09 s (2713.6 files/s, 434209.8 lines/s)
--- | ---
...
```
* bc22647 (origin/master, master) Rebuild project
...
| | * 5b3e5e0 (HEAD -> meta, origin/meta) generate project list (see #16)
| |/  
|/|   
