...
- alexandria  `python` `tools` `backup` `bookmarks` `organization` `software`
- ao  `python` `bash`
- ascii-physics-sim  `python` `simulations` `physics` `experiments` `ascii`
- Blender  `python` `extensions` `3d-graphics` `blender` `add-ons`
- board  `mathematics` `simulations` `combinatorics` `chess` `c++` `board-games`
- c2s  `python` `new-language` `compilers` `experimental` `transpilers` `programming-languages` `c`
- CA2  `python` `mathematics` `simulations` `art` `combinatorics` `geometry` `cellular-automata` `cgol` `discrete-math` `c`
- captcha  `hci` `security` `experiments`
- cellular-automata-experiments  `python` `mathematics` `simulations` `art` `combinatorics` `geometry` `cellular-automata` `cgol` `discrete-math`
- chrestomathy  `examples` `chrestomathy` `educational` `multiple` `reference`
- clover  `mathematics` `ai` `c++` `ml` `optimization`
- CogBench  `python` `tools` `interactive` `psychometrics` `software`
- consequi  `python` `tools` `tasks` `organization` `productivity` `software`
- englint  `tools` `language` `software`
- epidemic-modelling  `python` `mathematics` `simulations` `dynamical-systems` `modelling`
- finch  `python` `new-language` `c++` `compilers` `experimental` `transpilers` `programming-languages` `rust`
- foldz  `python` `mathematics` `simulations` `art` `geometry` `origami` `computational-geometry`
- fractals  `python` `mathematics` `dynamical-systems` `graphics` `numerical-analysis` `fractals`
- generic-github-user  `meta` `profile`
- geometry  `python` `mathematics` `analysis` `libraries` `geometry`
- grammars  `tools` `combinatorics` `libraries` `discrete-mathematics` `grammars` `experiments` `linguistics`
- graphs  `graphs` `mathematics` `python` `libraries` `data-structures` `graph-theory`
- hurricane  `mathematics` `libraries` `ai` `ml` `optimization`
- img-conv  `demos` `interactive` `image-processing` `convolutional-filters` `ml` `web` `javascript`
- keyboard-dynamics  `python` `mathematics` `simulations` `hci` `analysis` `statistics` `optimization`
- leetcode  `programming-challenges` `algorithms` `python` `leetcode`
- locus  `experiments` `python` `programming-languages` `esoteroic`
- not-python  `python` `grammars` `syntax-extensions` `experiments` `programming-languages`
- obfuscation  `python` `tools` `languages` `security`
- packings  `mathematics` `simulations` `combinatorics` `geometry` `c`
- programming-puzzles  `programming-puzzles` `python` `interactive`
- project-summary  `metadata` `python` `data-aggregation` `apis` `github`
- punchcard  `python` `utilities` `data-structures` `libraries`
- pythings  `python` `tools` `utilities` `metaprogramming`
- python-experiments  `python` `tools` `metaprogramming` `utilities` `experiments` `programming-languages`
- python-snippets  `python` `tools` `libraries` `helpers` `templates` `utilities` `programming-languages`
- quickplot  `graphs` `tools` `python` `libraries` `plotting` `matplotlib`
- rcas  `symbolic-computation` `mathematics` `libraries` `cas` `rust`
- roulette-curves  `python` `mathematics` `simulations` `art` `geometry`
- sandbox  `simulations` `demos` `interactive` `physics` `experiments` `web` `javascript`
- self-avoiding-walks  `python` `mathematics` `simulations` `combinatorics` `analysis` `random-walks`
- set  `tools` `software` `version-control` `software-development` `organization`
- shelf  `python` `tools` `software` `notes` `utilities` `command-line` `organization`
- supernova  `mathematics` `libraries` `ai` `ml` `optimization`
- tetris-variants  `python` `tetris` `interactive` `games`
- Time-Zone-Roles  `discord-bot` `javascript` `automation`
- transpiler  `transpilers` `programming-languages` `compilers`
- tsunami  `mathematics` `libraries` `ai` `ml` `optimization`
- unicode-art  `tools` `graphics` `diagrams`
- unmacro  `python` `automation` `hci` `macros` `vim` `text-processing` `experiments` `editors`
- utils  `python` `tools` `scripting` `unix` `utilities` `command-line`
- visual-computing-simulation  `python` `circuits` `simulations` `interactive` `computing`
- wordtetris  `python` `tetris` `games` `word-games`
- zeal  `python` `serialization` `markup` `file-formats`
...
cloc|github.com/AlDanial/cloc v 1.82  T=1.49 s (749.8 files/s, 46565.4 lines/s)
--- | ---

Language|files|blank|comment|code
:-------|-------:|-------:|-------:|-------:
Markdown|64|1022|0|11087
Python|148|2847|3255|9503
...
```
*   d68c324 (HEAD -> master, origin/master) Merge branch 'ap-todo'
|\  
| * 5930320 (origin/ap-todo, ap-todo-dates, ap-todo) remove flags from cloned tasks
| * 3bdec6d more cleanup and reorganization
| * 41fe6c3 (origin/ap-todo-dates) clean up parsing code
| * 2900abe various bug fixes and improvements for recurring task instantiation
| * 3cf0981 handle (some) recurring tasks
| * 987dd9a make stored state/todo database optional
| * e9e78c9 fix some parsing bugs
| * e8b2617 fix several mistakes
| * 353cf19 miscellaneous
| * 9f8dd5a make database backups conditional (based on config file)
| * 6da2f50 adjust logging based on verbosity level (set in config)
| * 7eedbdd move todo class to separate module
* |   676f5d6 Merge branch 'c-adts'
|\ \  
| * | 506e495 (origin/c-adts, c-adts) make array interface more compatible with OOP-style programming
| * | a55b295 misc.
| * | 6e6aebf add struct for describing data types
| * | fffb528 various improvements to Option and Result types
| * | e8065e5 miscellaneous
* | | 750d4df misc. reorganization
* | | 625155c move nushell scripts to subdirectory
* | |   31f4520 Merge branch 'lyre'
|\ \ \  
| * \ \   afaa3a1 (origin/lyre, lyre) Merge branch 'lyre-docs' into lyre
| |\ \ \  
...
* | | | | | 398ab92 Rebuild project
* | | | | |   7ba6c15 Merge branch 'comp-ext-infrastructure'
|\ \ \ \ \ \  
* \ \ \ \ \ \   73ff7a6 Merge branch 'ap-todo'
|\ \ \ \ \ \ \  
| | | | | | | | * 0a303f4 (origin/cei-py, cei-py) various fixes to compiler prototype
| | | | | | | | * fc4d829 move top-level compilation code into function
| | | | | | | | * 70d8fe1 properly resolve names in let (assignment declaration) statements
| | | | | | | | * 40949b4 fix various import issues
| | | | | | | | * bd140f4 amend previous commit
| | | | | | | | * e02c371 move some functions to sub-modules
| | | | | | | | * aa5f14e move Node and Token classes to their own modules
| | | | | | | | *   02eb2ee Merge branch 'cei-lib' into cei-py
| | | | | | | | |\  
| | | | | | | | | | *   5a43c4e (refs/stash) WIP on c-vec: 5813cdf add misc. Vec access methods
| | | | | | | | | | |\  
| | | | | | | | | | | * fd30f50 index on c-vec: 5813cdf add misc. Vec access methods
| | | | | | | | | | |/  
| | | | | | | | | | * 5813cdf (c-vec) add misc. Vec access methods
| | | | | | | | | | * 40e6c97 (origin/c-vec) add more Vec method descriptors
| | | | | | | |_|_|/  
| | | | | | |/| | |   
| | | | | | * | | | d87ce54 (origin/c-iter, c-iter) add range type and various iteration methods
| | | | | | * | | | dc0b74b implement some methods on iterators
| | | | | | * | | | ebe9dd9 implement abstract iterator interface
| | | | | | * | | | 558a84f add Result struct and associated methods
| | | | | | * | | | 6c11af3 add Vec.empty and Vec.remove methods
| | | | | | * | | | 9bd6775 add Vec.pop method
| | | | | | * | | | 550f5c9 add methods for adding elements to Vecs
| | | | | | * | | | d7c201f add vector iterator interface (WIP)
| | | | | | * | | | 5738084 add vector constructor and destructor functions
| | | | | | * | | | 1fe3225 add simple Vec (vector) struct
| | | | | | * | | | b14d9af add tools for basic exception handling
| | | | | | * | | | 8015b9d add basic array methods
| | | | | | * | | | 76ad6a2 add Array struct
| | | | | | * | | | 8ae2867 add Type struct
| | | | | | * | | | 40e00b5 add basic Option type to represent a value/result that may or may not exist
| | | | | | * | | |   65b8919 (origin/comp-ext-infrastructure, comp-ext-infrastructure, adt) Merge branch 'cei-lib' into comp-ext-infrastructure
| | | | | | |\ \ \ \  
| | | | | | | |_|/ /  
| | | | | | |/| | /   
| | | | | | | | |/    
| | | | | | | |/|     
| | | | | | | * | ff2fbbd (origin/cei-lib-vec, cei-lib-vec, cei-lib) add basic associated functions for Vec type
| | | | | | | * | c369e2a add draft of Vec type
| | | | | | | * | caca0c8 (origin/cei-lib) move standard library modules to subdirectory
| | | | | | * | | 20191a0 miscellaneous updates and fixes
| | | | | | * | | be2985b misc.
| | | | | | * | | 7c8c2d0 create dedicated constructor function for nodes converted from Lark classes
| | | | | | * | | e0251a7 rewrite (some of) compiler in more functional style
| | | | | | * | | ebdd554 add helper method for binding child nodes as class attributes
| | | | | | * | | 2c949de update pipenv files
| | | | | | * | | 8b948ae fix minor name resolution issue
| | | | | | * | | 6835a2a handle type inference on assignment statements
| | | | | | * | | 56ecd04 fix code style issues
| | | | | | * | |   3392a4f Merge branch 'cei-py-docs' into cei-py
| | | | | | |\ \ \  
| | | | | | | * | | c251736 (cei-py-docs) document emit_code method
| | | | | | | * | | 526a6c7 (origin/cei-py-docs) add docstrings to range_filter and resolve_names
| | | | | | * | | | e472389 add specialized node classes for convenience (adapted from Finch compiler)
| | | | | | * | | | 6d6145b add (some) type annotations (hints) to Node class
| | | | | | * | | | ca04061 add (some) type annotations to Token class
| | | | | | |/ / /  
| | | | | | * | | 327b1f7 add raise_error function for compiler error messages
| | | | | | * | | d3585ff add file containing some simple code for compiler testing
| | | | | | * | | 61cc186 misc.
| | | | | | * | | e5cd5d6 add basic code generator (currently targeting C)
| | | | | | * | | 93301be implement type checking/inference for call expressions
| | | | | | * | | efd09dd miscellaneous
| | | | | | * | | 78754ee more Node constructor improvements
| | | | | | * | | 3aea7ea add map functions to Node class
| | | | | | * | | d5346a5 add function for basic name resolution using lookup table
| | | | | | * | | 7cd37b3 assign node children to named attributes (to simplify other code)
| | | | | | * | | b0efb6a add convenience filters for rearranging parse tree
| | | | | | * | | ba60502 add some helper methods to Token class
| | | | | | * | | a3f1c8d add simple filter for desugaring ranges ("..")
| | | | | | * | | 3de909e improve Token class constructor
| | | | | | * | |   f2a9190 Merge branch 'pylist' into cei-py
| | | | | | |\ \ \  
| | | | | | | * | | 09eeb6f (pylist) minor changes to functionality
| | | | | | * | | | 10b7f62 make AST node constructor method more flexible
| | | |_|_|/ / / /  
| | |/| | | | | |   
| | | | | | | | | * 1996161 (origin/cei-rust, cei-rust) add Cargo files and main.rs
| | | | | | | | | * 767af26 add version of grammar for pest parser generator (Rust)
| | | |_|_|_|_|_|/  
| | |/| | | | | |   
| | * | | | | | | cb15479 fix style issues (compile.py)
| | * | | | | | | e7aa738 add Node and Token wrapper classes
| | * | | | | | |   1cf50f0 Merge branch 'cei-lib' into cei-py
| | |\ \ \ \ \ \ \  
| | | | |_|_|_|/ /  
| | | |/| | | | |   
| | | * | | | | | ee0f3fa add draft of linked list module
| | | * | | | | |   4b94113 Merge branch 'lyre-transpiler' into cei-lib
| | | |\ \ \ \ \ \  
...
| | |/ / / / / / / /  
| | | | | | | | | | * 1c160bf (origin/meta, meta) make build script flake8-compliant
| | | | | | | | | | *   7ad5bc8 Merge branch 'scripts' into meta
| | | | | | | | | | |\  
...
| | | | | | | | | | |/  
| | | | | | | | | | | * c18d35f (origin/leetcode, leetcode) add solution for #875
| | | | | | | | | | | * fc3b0ff add solution to "Make The String Great"
| | | | | | | | | | | * ef6d8c4 add solution for "Maximum Difference Between Increasing Elements"
| | | | | | | | | | | | * 53ee53a (origin/cei-examples, cei-examples) add wc.z
| | | | | | | | | | | | * 792a3fe add "hello world" experiments
| | | |_|_|_|_|_|_|_|_|/  
| | |/| | | | | | | | |   
| | | | | | | | | | | | * 1f6e109 (origin/cei-docs, cei-docs) add int range example to demonstrate usefulness
| | | | | | | | | | | | * 9f99232 add paragraph summarizing project philosophy
| | | |_|_|_|_|_|_|_|_|/  
| | |/| | | | | | | | |   
| | * | | | | | | | | | f0f95f4 add simple code sample (palindrome testing)
| | * | | | | | | | | | f6a955e add set of planned code filters
| | * | | | | | | | | |   8891e2a Merge branch 'ap-todo' into comp-ext-infrastructure
| | |\ \ \ \ \ \ \ \ \ \  
| | | | |_|_|_|_|_|/ / /  
| | | |/| | | | | | | |   
| | | * | | | | | | | | 275d249 fix relative import issue
...
| | | | | |_|_|_|_|/ / /  
| | | | |/| | | | | | |   
| | | | * | | | | | | | 45616ac (origin/pylist) add high-level overview of List class
...
| | | | |_|_|/  
| | | |/| | |   
| | | * | | | eb715df add new solutions from 08-28
