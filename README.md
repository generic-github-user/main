...
cloc|github.com/AlDanial/cloc v 1.82  T=0.79 s (504.4 files/s, 91986.0 lines/s)
--- | ---

Language|files|blank|comment|code
:-------|-------:|-------:|-------:|-------:
JavaScript|56|3808|3699|19036
Python|128|2515|3010|8492
...
```
* b8df567 (origin/metadata, metadata) add yaml-serialized list of directories with descriptions of each
| * 0c51023 (HEAD -> meta, origin/meta, origin/master, master) Rebuild project
