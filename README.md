...
cloc|github.com/AlDanial/cloc v 1.82  T=0.04 s (2255.1 files/s, 366215.8 lines/s)
--- | ---

Language|files|blank|comment|code
:-------|-------:|-------:|-------:|-------:
HTML|9|999|0|3400
Python|45|823|1127|2598
Markdown|26|291|0|1384
...
```
*   b5aa9c5 (HEAD -> master) Merge branch 'python-experiments'
|\  
...
* |   e5ff69d (origin/master) Merge branch 'quickplot'
|\ \  
...
|/  
| * 59d62c0 (origin/meta, meta) reflow branch list
