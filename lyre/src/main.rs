...
impl Add for ValueType {
    ...
    fn add(self, other: Self) -> Self {
        // ValueType
        match (self, other) {
            (ValueType::i8(value), ValueType::i8(other))  => ValueType::i8(value + other),
            (ValueType::i16(value), ValueType::i16(other))  => ValueType::i16(value + other),
            (ValueType::i32(value), ValueType::i32(other))  => ValueType::i32(value + other),
            (ValueType::i64(value), ValueType::i64(other))  => ValueType::i64(value + other),
            (ValueType::i128(value), ValueType::i128(other))  => ValueType::i128(value + other),
            _ => panic!()
        }
    }
}
